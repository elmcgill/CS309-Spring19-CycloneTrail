...
public class JSONRequestActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnJsonObj = (Button) findViewById(R.id.btnMakeJsonObjRequest);
        btnJsonArray = (Button) findViewById(R.id.btnMakeJsonAryRequest);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnMakeJsonObjRequest:
                makeJsonObjReq();
                break;
            case R.id.btnMakeJsonAryRequest:
                makeJsonArryReq();
                break;
        }
